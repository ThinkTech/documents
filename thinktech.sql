...
plan varchar(100), description text, priority varchar(30) default "normal" , date TIMESTAMP DEFAULT NOW(), status varchar(30) default "stand by" not null,duration int default 3,progression int default 0, user_id bigint not null,structure_id bigint not null,domain_id bigint,startedOn TIMESTAMP null,closedOn TIMESTAMP null);
