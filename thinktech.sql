...
create table projects_tasks(id bigint AUTO_INCREMENT PRIMARY KEY,name varchar(200) not null,description text,info text,priority varchar(30) default "normal" not null, duration int, status varchar(30) default "stand by" ,progression int default 0,project_id bigint not null,assignedTo bigint, startedOn TIMESTAMP null,closedOn TIMESTAMP null);
...
message text not null, priority varchar(30) default "normal" not null, date TIMESTAMP DEFAULT NOW(), status varchar(30) default "stand by",progression int default 0, closedOn TIMESTAMP null,closedBy int,user_id bigint not null,structure_id bigint not null,product_id bigint);
...
create table domains(id bigint AUTO_INCREMENT PRIMARY KEY,name varchar(300) not null,extension varchar(40) not null,emailOn boolean default false,email varchar(300),plan varchar(100),year int,action varchar(30),eppCode varchar(300),price int not null,date TIMESTAMP DEFAULT NOW(),status varchar(30) default "stand by" not null,emailActivatedOn TIMESTAMP null,registeredOn TIMESTAMP null,user_id bigint not null,structure_id bigint not null);
