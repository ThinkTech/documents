...
type varchar(200), country varchar(200),city varchar(200),location varchar(200),telephone varchar(60),email varchar(100),bp varchar(60),fax varchar(60),website varchar(200),ninea varchar(100),rc varchar(200),createdOn TIMESTAMP DEFAULT NOW());
