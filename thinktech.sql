...
date TIMESTAMP DEFAULT NOW(), status varchar(30) default "stand by",amount int not null,paidOn TIMESTAMP null,paidWith varchar(200),paidBy int,project_id bigint,discount_id bigint,group_id bigint,subscription_id bigint);
...
create table domains(id bigint AUTO_INCREMENT PRIMARY KEY,name varchar(300) not null,extension varchar(40) not null,email varchar(300),year int,action varchar(30),eppCode varchar(300),price int not null,structure_id bigint not null);
