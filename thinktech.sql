...
message text not null, priority varchar(30) default "normal" not null, date TIMESTAMP DEFAULT NOW(), status varchar(30) default "stand by",progression int default 0, autoClose boolean default false, closedOn TIMESTAMP null,closedBy int,user_id bigint not null,structure_id bigint not null,product_id bigint);
